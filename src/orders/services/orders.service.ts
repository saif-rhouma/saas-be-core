...
export class OrdersService {
  ...
  async createOrder(orderData: CreateOrderDto, userId: number, applicationId: number) {
    try {
      ...
      this.logger.error('Failed Create Order : ', error);
      return null;
    }
  }
  ...
  findAllByApplication(appId: number) {
    try {
      ...
      this.logger.error('findAllByApplication : ', error);
      return null;
    }
  }
  ...
  findAllActiveByApplication(appId: number) {
    try {
      ...
      this.logger.error('findAllActiveByApplication : ', error);
      return null;
    }
  }
  ...
  async findOneByApplication(id: number, appId: number) {
    try {
      ...
      this.logger.error('findOneByApplication : ', error);
      return null;
    }
  }
  ...
  async addAmount(order: Order, amount: number) {
    try {
      ...
      this.logger.error('addAmount : ', error);
      return null;
    }
  }
